...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        LogBuffer.i("CWBridge", "session start version=2.9.2-android")
        showCategory("bridge")
        refreshUi()
    }
    ...
    private fun refreshUi() {
        ...
        when {
            ...
            !RobloxLogBuffer.everReceived -> BridgeStatus.set(OverlayState.WAITING, "Waiting for CatWeb\u2026")
            else -> BridgeStatus.set(OverlayState.ACTIVE, "Listening")
        }
    ...
    private fun ensureOverlayPermission() {
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setMessage(
                "Allow CWBridge to draw over other apps so the status dot can sit on top of Roblox.\n\n" +
                    "\u2022 Green = listening\n\u2022 Yellow = waiting for CatWeb\n\u2022 Red = error\n\n" +
                    "Tap the dot to see the last 10 Roblox console lines."
            )
